...
'coord-assoc':{
  ...
  quarters:[
    {n:1,goal:'Understand the whole picture',period:'Observation quarter',fns:[],
     ...
     observation:{"title":"The observation entry — written after each thing watched","why":"Observation is work, and it is the only work of this quarter. Without a written entry, three months of watching leave nothing behind.","fields":[["a","What did I watch?","the contractor visit for the third-floor leak — start to finish, from the call to the sign-off"],["o","What did I see?",""],["w","What surprised me?",""],["n","What do I need?",""]],"note":"The third line is the one that matters here. A quarter of watching succeeds when the gap between what you assumed and what you saw is written down.","example":{"a":"Shadowed a contractor visit end to end — the third-floor leak, from the first call to the sign-off.","o":"It took four hours, and three of them were waiting. The contractor arrived without the part because nobody had asked what the fault was before booking him.","w":"I assumed the delay was the contractor being slow. <b>The delay was ours</b> — the booking call took ninety seconds and decided the whole afternoon.","n":"To see how the booking call is actually made. I have watched the repair three times and the call zero times."}},
    ...
    {n:4,goal:'It works because I own it',period:'First ownership',
     ...
     months:['<b>Stretch assignment starts.</b> Renewal Coordination begins.',
             'Deposit Accounting. A full renewal cycle, start to finish.',
     ...
     milestone:'The gate — every check, no averaging.'}],
  ...
  agm:{hours:'4.5',acts:[
    ...
    'Q4 — Step back from daily review. Watch a full month without intervening. Prepare the gate summary.']},
  gm:{hours:'1.5',acts:[
  ...
  gates:[
    ...
    ['Conduct','Every time across the five behaviours, from three sources'],
...
'assoc-sr':{
  ...
  quarters:[
    ...
    {n:4,goal:'The building runs through me',period:'Proof',
     fns:['Ambassador & Community Leadership Management','Community Engagement Lead Coordination','Preparing Community Events'],
...
const ACTIONS = [
  ...
  {id:'a4',who:'Beesan',  t:'Assign a teacher for each of the 7 new functions',m:'Craft is taught by whoever owns the function — usually a peer one level up',due:'31 Oct',lvl:'soon'},

...
'coord-assoc':[
  ...
  {k:'step',  n:'Handed over',           c:'#EF9F27', d:'Three go: the only two functions they own today drop to execute, and one passes to someone else entirely. Read as a loss unless it is explained — the ownership moves because they are freed for something heavier.',
   f:[['Classes - Attendance Check-ins','own → execute',''],
      ['Meetups - Attendance Check-ins','own → execute',''],
      ['Preparing Community Events','own → handed over','']]}
],

'assoc-sr':[
  {k:'own',   n:'Ownership — the core',  c:'#1D9E75', d:'Twenty-four functions become owned — twenty-three of them from executing, one from assisting. Ownership is one capability learned once and then extended, so four representative ones are taught deliberately and the rest follow.',
  ...
  {k:'new',   n:'New — the commercial side', c:'#7C5CBF', d:'Five are the first exposure to money and reporting — where the test is psychological rather than technical and the common failure is avoidance. The other three are community ownership handed over whole.',
...
'sr-agm':[
  {k:'release',n:'Released — the heart of it', c:'#E07050', d:'Twenty-four functions handed over. This is what the transition is: not mastering more, but letting go. Someone excellent at the Senior job who cannot delegate is less ready, not more.',
   f:[['Hosting Community Events','own → handed over','all of Community Experience goes'],
      ['Community Newsletter','own → handed over',''],['Ambassador & Community Leadership Management','own → handed over',''],
      ['Community Engagement Lead Coordination','own → handed over',''],['Marketing Events Support','own → handed over',''],
      ['Events & Experiences Community Marketing','own → handed over',''],['Preparing Community Events','own → handed over',''],
      ['Supporting Neighbor-led Community Events','own → handed over',''],['Preparing Community Spaces for Classes & Meetups','oversee → handed over',''],
      ['Classes - Attendance Check-ins','execute → handed over',''],['Meetups - Attendance Check-ins','execute → handed over',''],
      ['Maintenance coordination','own → handed over','daily operational coordination goes'],
      ['Housekeeping coordination','own → handed over',''],['Security & Watch coordination','own → handed over',''],
      ['Consumables Inventory Management','own → handed over',''],['Vacant Unit Inspections','oversee → handed over',''],
      ['Move-ins','own → handed over','front-line resident work goes'],['Move-in Inspections','own → handed over',''],
      ['Front Desk Hospitality','own → handed over',''],['Visitor Management','own → handed over',''],
      ['Renewal Support','own → handed over',''],['Renewal Coordination','own → handed over',''],
      ['Neighbor Check-in / Coffee Chat','own → handed over',''],['Survey Response Actioning','own → handed over','']]},
  ...
  {k:'new',   n:'New — real management',  c:'#7C5CBF', d:'Five responsibilities are new to this role. These four are the ones taken on directly, and they carry the first legal weight; the fifth arrives as oversight and sits with the functions held at arm’s length.',
...
'agm-gm':[
  ...
  {k:'release',n:'Released',             c:'#E07050', d:'Six pass down to the incoming AGM — the operational layer a scope owner should no longer hold.',
   f:[['Schedule Management','own → handed over','goes to the AGM'],['Reporting','own → handed over','goes to the AGM'],
      ['Shift handover','oversee → handed over',''],['Billing & Payment Support','oversee → handed over',''],
      ['Move-out & Move-out Inspection','oversee → handed over',''],['Pre-Move-in Coordination & Preparation','own → handed over','']]},
  {k:'new',   n:'Deepening to ownership', c:'#1D9E75', d:'Five move up to full ownership. Four are the commercial and legal end of the scope; the fifth is the daily walk of the property, which a scope owner does not delegate.',
